...
// //as we have not specified the type then user can give any type of arg and we will not get result as desired so need to write string explicityly
// var getFullName2 = function (fName2, lName2) {
...
// var getFullName2 = function (fName2, lName2) {
//     return fName2 + ' ' + lName2; //ts will automatically understand that output is string
//     //return true;//we will get error here ony as this return type is not string
